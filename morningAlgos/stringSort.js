// given a string of words (with space),
// return an array of words
// no built in functions!!!!
// "Did I shine my shoes today?" ->
// return ["Did", "I", "shine", "my", "shoes", "today?"]
// "two            words" -> ["two", "words"]
...
// write a function that, given a string of words(with space),
// return a new string with words in reverse sequence.
// "This is a test" -> "test a is This"

const reverseWordOrder = (str) => {
    let newArr = stringToWordArray(str);
    let newNewArr = "";
